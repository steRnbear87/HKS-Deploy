/**
 * Fleet App Inventory Snapshot Cron Route
 *
...
import { captureDueAppInventorySnapshots } from '@/lib/device-health/app-inventory-snapshot';
...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error('Error running app inventory snapshot cron:', error);
